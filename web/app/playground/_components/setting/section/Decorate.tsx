...
const DecorateSection: React.FC<DecorateSectionProps> = ({
  ...
  return (
    <>
      ...
      <HighlightOverlay itemId="border" highlightItemId={highlightItemId}>
      ...
      {/* Watermark Section */}
      <HighlightOverlay itemId="watermark" highlightItemId={highlightItemId}>
        <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-1">
                  {[
                    {
                      value: "left",
                      label: t("settingsPanel.makeup.alignments.left"),
                    },
                    {
                      value: "center",
                      label: t("settingsPanel.makeup.alignments.center"),
                    },
                    {
                      value: "right",
                      label: t("settingsPanel.makeup.alignments.right"),
                    },
                  ].map((align) => (
                    <button
                      key={align.value}
              ...
              <div className="flex justify-between items-center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdateSetting("labelColor", e.target.value)
                  }
