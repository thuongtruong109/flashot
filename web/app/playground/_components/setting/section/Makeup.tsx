...
const MakeupSection: React.FC<MakeupSectionProps> = ({
  ...
  return (
    <>
            ...
            <div className="space-y-3 pl-4">
              <label className="flex items-center justify-between cursor-pointer">
                ...
                <div className="relative">
                  <input
                    type="checkbox"
                    checked={settings.showProjectName || false}
                    onChange={(e) =>
                      onUpdateSetting("showProjectName", e.target.checked)
                    }
                    className="sr-only peer"
                  />
                  <div
                  ...
                  >
                    <svg
                      className={`size-3 text-sky-700 dark:text-sky-300 font-bold transition-opacity duration-200 ${
                        settings.showProjectName ? "opacity-100" : "opacity-0"
                      }`}
                      fill="currentColor"
                      stroke="none"
                      viewBox="0 0 24 24"
              ...
              {settings.showProjectName && (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      id="projectNameOpacity"
                      type="range"
                      min={0}
                      max={1}
                      step={0.01}
                      value={settings.projectNameOpacity ?? 1}
                      onChange={(e) =>
                        onUpdateSetting(
                          "projectNameOpacity",
                          parseFloat(e.target.value)
                  ...
                  {/* Project Name Font Weight slider */}
                  <div className="flex items-center space-x-2">
                    <label
                    ...
                    <input
                      id="projectNameFontWeight"
                      type="range"
                      min={100}
                      max={900}
                      step={100}
                      value={settings.projectNameFontWeight ?? 400}
                      onChange={(e) =>
                        onUpdateSetting(
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      max={20}
                      step={1}
                      value={settings.projectNameFontSize ?? 13}
                      onChange={(e) =>
                        onUpdateSetting(
                          "projectNameFontSize",
                          parseInt(e.target.value)
      ...
      <HighlightOverlay itemId="line-numbers" highlightItemId={highlightItemId}>
        <div className="space-y-4">
          <label className="flex items-center justify-between cursor-pointer">
            <div className="flex items-center space-x-1.5">
              <Hash
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-1.5">
                  <button
                    onClick={() =>
                      onUpdateSetting("lineNumberTextAlign", "left")
                    }
                    className={`px-2 rounded-md text-xs transition-all duration-200 capitalize ${
      ...
      {/* Caption Section */}
      <HighlightOverlay itemId="caption" highlightItemId={highlightItemId}>
        <div className="space-y-4">
