      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
          ...
          <button
            ...
            className="group flex items-center gap-2 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/30 text-white/90 hover:text-white text-sm font-medium rounded-md backdrop-blur-sm"
          >
